	...
	if($ischecked == 1) {
		if($furequester == null){
			if($numexten < 5) {
                ...
                echo'<script type="text/javascript">alert("You are not allowed to extend because you are only allowed to extend more than five times!!")</script>';
				//echo 'You are not allowed to extend because you are only allowed to extend more than five times.';
			}	
		} else {
			 echo'<script type="text/javascript">alert("You are not allowed to extend because it has already been requested by someone else!!")</script>';
		}
	} else {
         echo'<script type="text/javascript">alert("This book has not been checked out yet.!!")</script>';
